...
print('Average match length in tournaments is ' + str(mean(tournamentmatchtimelist)) + ' seconds.')
...
def usercontrol():
    userchoice = input('What would you like to see now?: "tournamentlist" or "tournamentmatchlist": ')
    if userchoice == 'tournamentlist':
        print(uniquetournamentlist)
        print('Now showing all unique tournaments!')
        usercontrol()

    if userchoice == 'tournamentmatchlist':
